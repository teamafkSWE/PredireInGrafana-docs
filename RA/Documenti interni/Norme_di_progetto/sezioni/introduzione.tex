...
Per evitare ambiguità nei documenti formali, viene fornito il documento \textit{Glossario\_v4.0.0}, contenente tutti i termini considerati di difficile comprensione. Perciò nella documentazione fornita ogni vocabolo contenuto in \textit{Glossario\_v4.0.0} è contrassegnato dalla lettera \textit{G} a pedice.
...
\begin{itemize}
	...
	\href{https://www.digital4.biz/hr/hr-transformation/digital-transformation-e-change-management-vanno-avanti-di-pari-passo/}{https://www.digital4.biz/hr/hr-transformation/}; \begin{itemize}
	...
	\item \S 2 - Processi Software;
	\item \S 3 - Sviluppo agile del software;
	\item \S 4 - Ingegneria dei requisiti;
	\item \S 8 - Test del software;
	\item \S 9 - Evoluzione del software;
	\item \S 19 - Gestione della progettazione;
	\item \S 21 - Gestione della qualità;
	\item \S 22 - Gestione della configurazione.
	\end{itemize}
