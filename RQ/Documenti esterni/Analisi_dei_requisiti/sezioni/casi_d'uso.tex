...
% - Casi d'uso: Principali - %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\end{figure}	
		...
		\begin{itemize}
			...
			\item\textbf{Estensioni}: 
				\begin{enumerate}
					\item hyperref[par:UC7]{UC7} estende \hyperref[par:UC1.3]{UC1.3}: viene visualizzato un messaggio d'errore se non è stato scelto alcun algoritmo per l'addestramento;
					\item hyperref[par:UC8]{UC8} estende \hyperref[par:UC1.3]{UC1.3}: viene visualizzato un messaggio d'errore se il file di addestramento è incompatibile con l'algoritmo scelto.
				\end{enumerate}
	...
	\subsubsection{UC1.3 - Conferma procedura addestramento}
		\begin{itemize}
			...
			\item\textbf{Estensioni}:
			\begin{enumerate}
				\item hyperref[par:UC7]{UC7}: viene visualizzato un messaggio d'errore se non è stato scelto alcun algoritmo per l'addestramento;
				\item \hyperref[par:UC8]{UC8}: viene visualizzato un messaggio d'errore se il file di addestramento è incompatibile con l'algoritmo scelto.
			\end{enumerate}
	...
	\subsubsection{UC1.5 - Visualizzazione messaggio di alert "Addestramento non riuscito"}
		\begin{itemize}
			...
			\item\textbf{Scenario principale}:
				\begin{enumerate}
				\item l'utente visualizza il messaggio di alert "Addestramento non riuscito" in cui viene segnalato che non è stato possibile addestrare l'algoritmo perché è stato caricato un CSV incompatibile (\hyperref[par:UC7]{UC7}) oppure nel caso in cui non sia stato scelto l'algoritmo da addestrare (\hyperref[par:UC8]{UC8});
				\item l'utente clicca il pulsante "Conferma" per proseguire.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\end{figure}	
		...
		\begin{itemize}
			...
			\item\textbf{Estensioni}:
				\begin{enumerate}
					\item\hyperref[par:UC9]{UC9} estende \hyperref[par:UC2.1]{UC2.1}: viene visualizzato un messaggio di alert nel caso in cui sia già presente un file JSON caricato nel plug-in "Predire in Grafana";
					\item\hyperref[par:UC10]{UC10} estende \hyperref[par:UC2.2]{UC2.2}: viene visualizzato un messaggio d'errore nel caso in cui l'operazione di caricamento del file non sia andata a buon fine.
				\end{enumerate}	
		...
		\begin{itemize}
			...
			\item\textbf{Estensioni}: \hyperref[par:UC9]{UC9}: viene visualizzato un messaggio di alert nel caso in cui sia già presente un file JSON caricato nel plug-in "Predire in Grafana".
				\end{enumerate}
			\end{itemize}
		...
		\begin{itemize}
			...
			\item\textbf{Estensioni}: \hyperref[par:UC10]{UC10}: viene visualizzato un messaggio d'errore nel caso in cui l'operazione di caricamento del file non sia andata a buon fine.
					
		\end{itemize}
		
		\label{par:UC2.3}
	\subsection{UC2.3 - Visualizzazione messaggio di notifica "Avvenuto successo caricamento JSON"}
		\begin{itemize}
			\item\textbf{Attore primario}: utente generico;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\subsection{UC3 - Collegamento del predittore al flusso dati}
		...
		\begin{itemize}
			...
			\item\textbf{Estensioni}:
				\begin{enumerate}
					\item\hyperref[par:UC11]{UC11} estende \hyperref[par:UC3.3]{UC3.3}: viene visualizzato un messaggio di errore soglia non valida nel caso venga inserito un valore non consentito;
					\item\hyperref[par:UC12]{UC12} estende \hyperref[par:UC3.4]{UC3.4}: viene visualizzato un messaggio d'errore nel caso il collegamento non sia stato possibile.
	...
	\subsubsection{UC3.3 - Impostazione delle soglie}
		\begin{itemize}
			...
			\item\textbf{Estensioni}: \hyperref[par:UC11]{UC11}: viene visualizzato un messaggio di errore "Soglia Non Valida" nel caso venga inserito un valore non consentito.
		\end{itemize}
	...
	\subsubsection{UC3.4 - Conferma collegamento}
		\begin{itemize}
			...
			\item\textbf{Estensioni}: \hyperref[par:UC12]{UC12}: viene visualizzato un messaggio d'errore nel caso il collegamento non sia stato possibile.		
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\item\textbf{Postcondizioni}:
			...
			\item\textbf{Estensioni}:
				\begin{enumerate}
					\item \hyperref[par:UC13]{UC13} estende \hyperref[par:UC5.2]{UC5.2}: visualizzazione messaggio d'errore "Politica temporale non definita";
					\item \hyperref[par:UC14]{UC14} estende \hyperref[par:UC5.2]{UC5.2}: visualizzazione messaggio d'errore "Nessun predittore collegato".
	...
	\subsubsection{UC5.2 - Avvio monitoraggio}
		\begin{itemize}
			...
			\item\textbf{Estensioni}:
				\begin{enumerate}
					\item \hyperref[par:UC13]{UC13}: visualizzazione messaggio d'errore "Politica temporale non definita";
...
% - Casi d'uso: Estensioni - %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\label{par:UC7}
	\subsection{UC7 - Visualizzazione messaggio d'errore "Nessun algoritmo selezionato"}
		\begin{itemize}
			\item\textbf{Attore primario}: utente generico;
	...
	\label{par:UC8}
	\subsection{UC8 - Visualizzazione messaggio d'errore "File CSV incompatibile"}
		\begin{itemize}
			\item\textbf{Attore primario}: utente generico;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\label{par:UC9}
	\subsection{UC9 - Visualizzazione messaggio di alert "File JSON già caricato"}
		\begin{itemize}
			\item\textbf{Attore primario}: utente generico;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
	...
	\label{par:UC10}
	\subsection{UC10 - Visualizzazione messaggio d'errore "Caricamento file JSON" }
		\begin{itemize}
			\item\textbf{Attore primario}: utente generico;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\label{par:UC11}
	\subsection{UC11 - Visualizzazione messaggio d'errore "Soglia non valida"}
		\begin{itemize}
			\item\textbf{Attore primario}: utente generico;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\label{par:UC13}
	\subsection{UC13 - Visualizzazione messaggio d'errore "Politica temporale non definita"}
		\begin{itemize}
			\item\textbf{Attore primario}: utente generico;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\label{par:UC14}
	\subsection{UC14 - Visualizzazione messaggio d'errore "Nessun predittore collegato"}
		\begin{itemize}
			\item\textbf{Attore primario}: utente generico;
