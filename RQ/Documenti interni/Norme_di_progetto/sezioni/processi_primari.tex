...
descrivendo brevemente la loro funzione. Sono possibili due tipi di commenti: in linea tramite l’utilizzo del doppio slash (\texttt{//}) o a blocco tramite la costruzione \texttt{//**...*/}.
\begin{lstlisting}
